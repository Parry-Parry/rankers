from transformers import PreTrainedModel, PreTrainedTokenizer, FlaxAutoModelForSequenceClassification, AutoTokenizer, OptionalDependencyNotAvailable, AutoConfig
import pandas as pd
...
class FlaxCat(PreTrainedModel):
    ...
    def load_state_dict(self, model_dir):
        ...
        return self.classifier.load_state_dict(self.architecture_class.from_pretrained(model_dir).state_dict())
    ...
    def from_pretrained(cls, model_dir_or_name : str, num_labels=2):
        ...
        classifier = cls.architecture_class.from_pretrained(model_dir_or_name, num_labels=num_labels)
