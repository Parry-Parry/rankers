...
class FlaxSeq2Seq(FlaxPreTrainedModel):
    ...
    def load_state_dict(self, model_dir):
        ...
        return self.classifier.load_state_dict(
            FlaxAutoModelForSeq2SeqLM.from_pretrained(model_dir).state_dict()
        )

    def to_pyterrier(self) -> "FlaxSeq2SeqTransformer":
        if not PT_AVAILIBLE:
            raise OptionalDependencyNotAvailable()
        return FlaxSeq2SeqTransformer.from_model(
    ...
    def from_pretrained(cls, model_dir_or_name: str, num_labels=2):
        ...
        classifier = FlaxAutoModelForSeq2SeqLM.from_pretrained(
